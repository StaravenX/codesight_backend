...
import com.codesight.auth.verification.CodeSender;
import com.codesight.auth.verification.VerificationCodeStore;
...
class VerificationServiceTest {
    ...
    void testSendCode_Success() {
        ...
        SendCodeResult result = verificationService.sendCode(VerificationScene.LOGIN, "test@example.com");
        ...
        verify(codeSender, times(1)).sendCode(eq("LOGIN"), eq("test@example.com"), anyString(), eq(5));
    }
    ...
    void testSendCode_RateLimitExceeded() {
        ...
        BusinessException ex = assertThrows(BusinessException.class, () -> 
            verificationService.sendCode(VerificationScene.LOGIN, "test@example.com"));
        ...
        verify(codeSender, never()).sendCode(any(), anyString(), anyString(), anyInt());
    }
